/* global aaBulletinBoardJsSettingsDefaults, aaBulletinBoardJsSettingsOverride, objectDeepMerge */

$(document).ready(() => {
    'use strict';

    // Build the settings object
    let aaBulletinBoardJsSettings = typeof aaBulletinBoardJsSettingsDefaults !== 'undefined' ? aaBulletinBoardJsSettingsDefaults : null;

    if (aaBulletinBoardJsSettings && typeof aaBulletinBoardJsSettingsOverride !== 'undefined') {
        aaBulletinBoardJsSettings = objectDeepMerge(
            aaBulletinBoardJsSettings,
            aaBulletinBoardJsSettingsOverride
        );
    }
    ...
    const _videoLinkToVideoElement = (url) => {
        ...
        return `<figure class="media"><div class="oembed-video ${ext}-video"><video controls><source src="${url}" type="${mime}">${aaBulletinBoardJsSettings.l10n.video.elementNotSupported}</video></div></figure>`;
    };
