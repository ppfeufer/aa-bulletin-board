...
# Setup variables
project_name = "aa-bulletin-board"
project_description = "A simple bulletin board for Alliance Auth"
project_license = "GPLv3"
project_author = "Peter Pfeufer"
project_author_email = "development@ppfeufer.de"
project_git_url = "https://github.com/ppfeufer/aa-bulletin-board"
...
project_install_requirements = ["allianceauth>=2.9.3", "django-ckeditor", "unidecode"]
